...
const InfoCard: React.FC<InfoCardProps> = ({ title, items, icon, itemIcons }) => {
  return (
    <div className="bg-gray-800/50 backdrop-blur-sm border border-purple-500/30 rounded-2xl p-6 shadow-lg shadow-purple-900/20 transform transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:shadow-cyan-500/20">
